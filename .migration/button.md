...
- `apps/web/src/components/ui/button.tsx:2`: `import { Slot } from "@radix-ui/react-slot"` becomes
...
- Leftover scan clean: `grep -n "radix-ui\|@radix-ui" apps/web/src/components/ui/button.tsx`
  returns no matches.
